...
// * 1.0 Теперь, когда мы превратили переменные в свойства объекта, то присвоим им исходные значения, например title — строка, а screenPrice — 0.
// * 1.1 Далее мы берём функцию за функцией и превращаем их в методы объекта. А вместо переменных у нас теперь свойства объекта appData, поэтому title заменяется на appData.title и т.п.
const appData = {
	ROLLBACK: 5,
	title: '',
	screens: '',
